...
public class MapGenerator : MonoBehaviour
{
    ...
    [Range(0,6)]
    public int EditorlevelOfDetail; //Can have values of 1, 2, 4, 6, 8, 10, 12
    ...
    private MapData GenerateMapData(Vector2 center){
        float[,] noiseMap = Noise.GenerateNoiseMap(mapChunkSize, mapChunkSize, seed, noiseScale, octaves, persistance, lacunarity, center + offset, normaliseMode);
